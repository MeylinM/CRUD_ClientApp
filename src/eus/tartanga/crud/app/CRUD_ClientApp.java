...
import eus.tartanga.crud.userInterface.ConcertController;
...
public class CRUD_ClientApp extends Application {
    ...
    public void start(Stage stage) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/eus/tartanga/crud/userInterface/ConcertView.fxml"));
